...
impl DarkOracleUpdater {
	...
	pub async fn disable_asset(
		...
		let call_builder = self
			...
			.gas(500_000)
			.max_priority_fee_per_gas(priority_fee * 20); // Extra priority fee for unregistering assets, as it blocks everything else.
	...
	pub async fn enable_asset(
		...
		let call_builder = self
			...
			.gas(500_000)
			.max_priority_fee_per_gas(priority_fee * 20);
